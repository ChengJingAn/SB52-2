...
let titleAudio = new loadSound('EP_52_Audio_38');

let bodyAudio = new loadSound('EP_52_Audio_38');
let subBodyAudio = new loadSound('EP_52_Audio_38');

let wordAudio1 = new loadSound('EP_52_Audio_38');
let wordAudio2 = new loadSound('EP_52_Audio_38');
let wordAudio3 = new loadSound('EP_52_Audio_38');
let wordAudio4 = new loadSound('EP_52_Audio_38');
...
export default function BaseShot() {
    ...
    function setBackground(imgUrl, optionNum = -1, backState = 1) {
        if (imgUrl != oldBackgroundImage) {
            ...
            myImage1.current.src = prePathUrl() + "images/SB_52_BG/" + imgUrl + ".svg";
            setSuitableBackground(backState);

            setTimeout(() => {
                myImage.current.src = prePathUrl() + "images/SB_52_BG/" + imgUrl + ".svg";
        ...
        >
            <div
                ...
                <img draggable={false} height={"100%"}
                    ref={myImage}
                    src={prePathUrl() + "images/SB_52_BG/SB_52_Intro_BG_1_Sky.svg"}
                />
            </div>
            <div
                ref={imageBack1}
